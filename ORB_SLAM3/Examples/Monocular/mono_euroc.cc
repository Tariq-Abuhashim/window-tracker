...
// ./Examples/Monocular/mono_euroc Vocabulary/ORBvoc.txt Examples/Monocular/dji.yaml /media/mrt/Whale/data/mission_systems/window_tracker/data/DJI_longer/images/ /media/mrt/Whale/data/mission_systems/window_tracker/data/DJI_longer/times.txt
...
{  
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
		...
		cout << "number of images in sequence = " << nImages[seq] << endl;
